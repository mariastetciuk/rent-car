...
<ul className={scss.list}>
    <li className={scss.item}><a href="https://www.linkedin.com/in/mariia-stetsiuk/" className={scss.link}>
        <AiFillLinkedin size='30px'  className={scss.icon}/>
        </a></li>
    <li className={scss.item}><a href="https://github.com/mariastetciuk" className={scss.link}>
