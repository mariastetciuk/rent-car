  ...
  return (
    <>
      <section className={scss.hero}>
        <Container>
          <h1 className={scss.hero__title}>
            Car Rentals: Search,{' '}
            <span className={scss.hero__titleSpan}>Compare & Save</span>{' '}
          </h1>
        ...
        <Container className={scss.benefits__container}>
          ...
          <ul className={scss.benefits__list}>
            <li className={scss.benefits__item}>
              <div className={scss.benefits__icon}>
                <BiSolidCar size="60px" />
              </div>

              <h3 className={scss.benefits__name}> Variety of cars</h3>
              <p className={scss.benefits__text}>
                The available range of cars makes it possible to provide a
                significant number of customers and find a car that meets the
            ...
            <li className={scss.benefits__item}>
              ...
              <p className={scss.benefits__text}>
                Best prices and no hidden fees. When booking a car with us, you
                do not you will come across a red tape, queue behind desired
                car. ignoring or double payments.
              </p>
            </li>
            <li className={scss.benefits__item}>
              <div className={scss.benefits__icon}>
              ...
              <p className={scss.benefits__text}>
                We employ the best specialists in their field who will be happy
